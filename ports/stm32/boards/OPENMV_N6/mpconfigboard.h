...
#define MICROPY_HW_ETH_RMII_REF_CLK             (pin_F7) // RGMII_RX_CLK
#define MICROPY_HW_ETH_RMII_CRS_DV              (pin_F10) // RGMII_RX_CTL
...
#define MICROPY_HW_ETH_RMII_TX_EN               (pin_F11) // RGMII_TX_CTL
