...
#define MICROPY_HW_ETH_MII_TXD1      (pin_B13)
#define MICROPY_HW_ETH_MII_TXD2      (pin_C2)
#define MICROPY_HW_ETH_MII_TXD3      (pin_E2)
#define MICROPY_HW_ETH_MII_RX_CLK    (pin_A1)
#define MICROPY_HW_ETH_MII_RX_DV     (pin_A7)
#define MICROPY_HW_ETH_MII_RXD0      (pin_C4)
#define MICROPY_HW_ETH_MII_RXD1      (pin_C5)
#define MICROPY_HW_ETH_MII_RXD2      (pin_B0)
#define MICROPY_HW_ETH_MII_RXD3      (pin_B1)
