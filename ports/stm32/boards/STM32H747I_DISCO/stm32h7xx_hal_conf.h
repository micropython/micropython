...
// Additional HAL modules needed for this board
#define HAL_HSEM_MODULE_ENABLED     // Dual-core synchronization (OpenAMP)
#define HAL_QSPI_MODULE_ENABLED     // External QSPI flash storage
