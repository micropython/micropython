#define MICROPY_HW_BOARD_NAME       "ONYX-L452RE_P"
#define MICROPY_HW_MCU_NAME         "STM32L452RE_P"
...
#define MICROPY_HW_CLK_PLLN (38)
#define MICROPY_HW_CLK_PLLP (RCC_PLLP_DIV7)
#define MICROPY_HW_CLK_PLLQ (RCC_PLLQ_DIV2)
#define MICROPY_HW_CLK_PLLR (RCC_PLLR_DIV6)
#define MICROPY_HW_FLASH_LATENCY FLASH_LATENCY_4
#define MICROPY_HW_UART_REPL_BAUD   2400
#endif
#ifdef USE16MHZ
#define MICROPY_HW_CLK_PLLM (1)
