// 
// Hardware definition file for the Nucleo Board
//
// In this case an existing Nucleo-F767ZI was modified by exchanging
// the MCU for a STM32H743ZI, whih is pin-to-pin compatible.
...
// To use openocd run "OPENOCD_CONFIG=boards/openocd_stm32h7.cfg" in
// the make command.

#define MICROPY_HW_BOARD_NAME       "NUCLEO-H743ZI"
