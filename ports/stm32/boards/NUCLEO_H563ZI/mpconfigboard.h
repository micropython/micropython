...
#define MICROPY_HW_UART11_RX                 (pin_F4) // CN12-38 Shared with orange LED.
...
#if defined(MICROPY_HW_UART11_RX) && MICROPY_HW_UART11_RX == pin_F3
#define MICROPY_HW_LED2                     (pin_G4) // Red
#else
#define MICROPY_HW_LED2                     (pin_F4) // Orange shared with UART11
