...
CORE_RTSS_HP := $(if $(filter RTSS_HP,$(MCU_CORE)),1,0)

# MicroPython settings
MICROPY_FLOAT_IMPL = float
MICROPY_PY_BLUETOOTH = $(CORE_RTSS_HP)
MICROPY_BLUETOOTH_NIMBLE = $(CORE_RTSS_HP)
MICROPY_PY_LWIP = $(CORE_RTSS_HP)
MICROPY_PY_NETWORK_CYW43 = $(CORE_RTSS_HP)
MICROPY_PY_SSL = $(CORE_RTSS_HP)
MICROPY_SSL_MBEDTLS = $(CORE_RTSS_HP)
