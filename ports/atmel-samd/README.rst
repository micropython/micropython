...
PA08                    ``D11`` / ``SDA``   ``NINA_RESETN``      ``D4``           ``MICROPHONE_DO``            ``D4`` / ``SD_CS``                                                                       ``D4``            ``D4``                            ``D4``                  ``D0`` / ``SDA``
...
PA12                    ``SD_MOSI``         ``NINA_MOSI``        ``MISO``         ``REMOTEIN`` / ``IR_RX``     ``MISO``                ``MISO``          ``MISO``                                       ``MISO``                                            ``MISO``
PA13                    ``SD_SCK``          ``NINA_MISO``                         ``ACCELEROMETER_INTERRUPT``                                                                                           ``FLASH_CS``                                        ``D38``
PA14                    ``SD_CS``           ``NINA_CS``          ``D2``           ``BUTTON_B`` / ``D5``                                                                                                 ``D2``            ``D2``                            ``D2``
PA15                    ``SD_MISO``         ``NINA_SCK``         ``D5``           ``SLIDE_SWITCH`` / ``D7``    ``D5``                  ``D5``            ``D5``                                         ``D5``            ``D5``                            ``D5``
...
PA27                    ``SD_CD``           ``NINA_GPIO0``                                                                                                                                                                ``GREEN_LED``                     ``GREEN_LED``
PA28                                        ``NINA_ACK``                          ``BUTTON_A`` / ``D4``
PA29
