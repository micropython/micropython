...
STATIC const mp_rom_map_elem_t board_global_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_D30), MP_ROM_PTR(&pin_PB22) },
    { MP_ROM_QSTR(MP_QSTR_D31), MP_ROM_PTR(&pin_PB23) },
    { MP_ROM_QSTR(MP_QSTR_D38), MP_ROM_PTR(&pin_PA13) },

    // UART pins
    { MP_ROM_QSTR(MP_QSTR_TX), MP_ROM_PTR(&pin_PA10) },
    { MP_ROM_QSTR(MP_QSTR_RX), MP_ROM_PTR(&pin_PA11) },
    { MP_ROM_QSTR(MP_QSTR_TX1), MP_ROM_PTR(&pin_PB22) },
    { MP_ROM_QSTR(MP_QSTR_RX1), MP_ROM_PTR(&pin_PB23) },
