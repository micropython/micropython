## 1. Deploy the MicroPython firmware to the Makerdiary RT1011 Nano Kit.

The Makerdiary RT1011 Nano Kit comes pre-installed with a UF2 bootloader. It can
...
reinstall the bootloader using the procedire below.
...
## 2. Reinstall the bootloader Makerdiary RT1011 Nano Kit.
...
and extract the file  tinyuf2-makerdiary_rt1011-0.21.0.bin. You may as well go for a newer release.
...
```
Wait until a drive icon appears on the computer (or mount it explicitly). At this point the bootloader is installed. You can now copy the MicroPyhton .uf2 file to the boards.
