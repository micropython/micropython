...
STATIC const mp_rom_map_elem_t board_global_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_SCK),  MP_ROM_PTR(&pin_GPI7) },  // def from Espressif MP, D1 Mini pin D5 GPIO14
    ...
    { MP_ROM_QSTR(MP_QSTR_MISO), MP_ROM_PTR(&pin_GPIO9) }, // def from Espressif MP, D1 Mini pin D6 GPIO12
    ...
    { MP_ROM_QSTR(MP_QSTR_MOSI), MP_ROM_PTR(&pin_GPIO11) },// def from Espressif MP, D1 Mini pin D7 GPIRO13
    ...
    { MP_ROM_QSTR(MP_QSTR_SDA),  MP_ROM_PTR(&pin_GPIO33) },// def from Espressif MP, D1 Mini pin D2 GPIO4
    ...
    { MP_ROM_QSTR(MP_QSTR_SCL),  MP_ROM_PTR(&pin_GPIO35) },// def from Espressif MP, D1 Mini pin D1 GPIO5
