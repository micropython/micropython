...
#define MICROPY_PY_BUILTINS_STR_CAPITALIZE      (0)
#define MICROPY_PY_BUILTINS_STR_TITLE           (0)
#define MICROPY_PY_BUILTINS_STR_TRANSLATE       (0)
#define MICROPY_PY_BUILTINS_STR_REMOVEFIX       (0)
#define MICROPY_PY_BUILTINS_STR_IS_CHECKS       (0)
