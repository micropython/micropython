...
static const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    // SARA R410M Modem
    { MP_ROM_QSTR(MP_QSTR_SARA_TX), MP_ROM_PTR(&pin_GPIO4) },
    { MP_ROM_QSTR(MP_QSTR_GP4), MP_ROM_PTR(&pin_GPIO4) },
    { MP_ROM_QSTR(MP_QSTR_SARA_RX), MP_ROM_PTR(&pin_GPIO5) },
    { MP_ROM_QSTR(MP_QSTR_GP5), MP_ROM_PTR(&pin_GPIO5) },
    { MP_ROM_QSTR(MP_QSTR_SARA_CTS), MP_ROM_PTR(&pin_GPIO6) },
    ...
    { MP_ROM_QSTR(MP_QSTR_D10), MP_ROM_PTR(&pin_GPIO11) },
    ...
    // SARA R410M Modem control signals
    { MP_ROM_QSTR(MP_QSTR_SARA_BTN), MP_ROM_PTR(&pin_GPIO13) },
    { MP_ROM_QSTR(MP_QSTR_SARA_RST), MP_ROM_PTR(&pin_GPIO14) },
