...
static const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_A1), MP_ROM_PTR(&pin_P0_31) },
    ...
    { MP_ROM_QSTR(MP_QSTR_D5), MP_ROM_PTR(&pin_P0_18) },
    ...
    { MP_ROM_QSTR(MP_QSTR_MAXTEMP_SCL), MP_ROM_PTR(&pin_P1_13) },
    { MP_ROM_QSTR(MP_QSTR_MAXTEMP_SDA), MP_ROM_PTR(&pin_P1_15) },
    ...
    { MP_ROM_QSTR(MP_QSTR_LED), MP_ROM_PTR(&pin_P0_27) },
