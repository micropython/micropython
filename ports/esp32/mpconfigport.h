...
extern const struct _mp_obj_module_t mp_module_sdcard;
...
#define SDCARD_BUILTIN_MODULE { MP_OBJ_NEW_QSTR(MP_QSTR_sdcard), (mp_obj_t)&mp_module_sdcard },
#else
#define SDCARD_BUILTIN_MODULE
#endif
