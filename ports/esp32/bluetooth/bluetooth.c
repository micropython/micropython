    ...
    switch (event) {
      ...
      case ESP_GAP_BLE_SCAN_RESULT_EVT:
        ...
        if (adv_name != NULL && connect) {
            ...
            char* device = "00:00:00:00:00:00";
            ESP_LOGI(GATTC_TAG, "Addresses are the same: %d <-> %d", strncmp(device, (char* )param->scan_rst.bda), strncmp(device2, (char* )param->scan_rst.bda));
