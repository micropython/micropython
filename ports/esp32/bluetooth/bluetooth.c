    ...
    switch (event) {
      ...
      case ESP_GAP_BLE_SCAN_RESULT_EVT:
        ...
        if (adv_name != NULL && connect) {
            ...
            ESP_LOGI(GATTC_TAG, "Addresses are the same: %d <-> %d <-> %d", strcmp(device, (char* )param->scan_rst.bda), strcmp(device2, (char* )param->scan_rst.bda), strcmp(device3, param->scan_rst.bda));
