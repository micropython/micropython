...
STATIC const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    // Flash SPI
    { MP_ROM_QSTR(MP_QSTR_IOSCK), MP_ROM_PTR(&pin_P0_19) },     // 0.00 - IOSCK | Flash Serial Clock
    { MP_ROM_QSTR(MP_QSTR_IOCSN), MP_ROM_PTR(&pin_P0_12) },     // 0.00 - IOCSN | Flash /Chip Select
    { MP_ROM_QSTR(MP_QSTR_IO0), MP_ROM_PTR(&pin_P0_14) },       // 0.00 - IO0 | Flash Data 0
    { MP_ROM_QSTR(MP_QSTR_IO1), MP_ROM_PTR(&pin_P0_21) },       // 0.00 - IO1 | Flash Data 1
    { MP_ROM_QSTR(MP_QSTR_IO2), MP_ROM_PTR(&pin_P0_23) },       // 0.00 - IO2 | Flash Data 2
    { MP_ROM_QSTR(MP_QSTR_IO3), MP_ROM_PTR(&pin_P1_00) },       // 0.00 - IO3 | Flash Data 3
