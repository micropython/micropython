...
STATIC const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_D10), MP_ROM_PTR(&pin_P0_02) },
    ...
    { MP_ROM_QSTR(MP_QSTR_D11), MP_ROM_PTR(&pin_P0_03) },
    ...
    { MP_ROM_QSTR(MP_QSTR_LED1), MP_ROM_PTR(&pin_P0_07)  },
    ...
    { MP_ROM_QSTR(MP_QSTR_D8), MP_ROM_PTR(&pin_P0_09) },
	
    { MP_ROM_QSTR(MP_QSTR_P0_10), MP_ROM_PTR(&pin_P0_10) },
    { MP_ROM_QSTR(MP_QSTR_D9), MP_ROM_PTR(&pin_P0_10) },
    ...
    { MP_ROM_QSTR(MP_QSTR_D13), MP_ROM_PTR(&pin_P0_30) },
    { MP_ROM_QSTR(MP_QSTR_SCK), MP_ROM_PTR(&pin_P0_30) },
    ...
    // Nothing connected to anything on P1 port
