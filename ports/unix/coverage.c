...
STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_type_stest_fileio, MP_QSTR_stest_fileio, MP_TYPE_FLAG_NONE, MP_TYPE_NULL_MAKE_NEW,
...
STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_type_stest_textio2, MP_QSTR_stest_textio2, MP_TYPE_FLAG_NONE, MP_TYPE_NULL_MAKE_NEW,
