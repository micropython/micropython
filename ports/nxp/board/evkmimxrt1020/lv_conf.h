...
#define LV_VDB_SIZE         ((LV_VER_RES * LV_HOR_RES) / 1)
...
#define LV_VDB_PX_BPP       16       /*LV_COLOR_SIZE comes from LV_COLOR_DEPTH below to set 8, 16 or 32 bit pixel size automatically */
