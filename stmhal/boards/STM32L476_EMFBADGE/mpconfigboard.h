...
#define MICROPY_HW_BOARD_NAME       "L476_EMFBADGE"
...
// USRSW is pulled low. Pressing the button makes the input go low.
#define MICROPY_HW_USRSW_PIN        (pin_D10)
...
#define MICROPY_HW_LED3             (pin_B13) //torch
