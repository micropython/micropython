...
To run all tests in the test suite, use ``make``:
...
.. warning::
   Make sure you are in the port directory where MicroPython was built before running
   the tests i.e ``cd ports/xyz``. Running the tests outside your port will not work.
