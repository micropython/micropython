...
.. class:: LDO(channel, voltage_mv, adjustable=True, owned_by_hw=True)
    ...
    Supported optional arguments:
      ...
      - *owned_by_hw*: If the LDO channel is owned by hardware, then software configurations can be overridden by hardware (e.g. eFuse)
