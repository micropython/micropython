...
.. data:: tls.PROTOCOL_TLS_CLIENT
          tls.PROTOCOL_TLS_SERVER
          tls.PROTOCOL_DTLS_CLIENT (when DTLS support is enabled)
          tls.PROTOCOL_DTLS_SERVER (when DTLS support is enabled)
