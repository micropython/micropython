...
This class allows access to Zephyr-provided Displays
(`zephyr,display chosen Node <https://docs.zephyrproject.org/latest/build/dts/api/api.html#zephyr-specific-chosen-nodes>`_
and `zephyr,displays Node <https://docs.zephyrproject.org/latest/build/dts/api/bindings/display/zephyr%2Cdisplays.html>`_)
via an API reproducing the Zephyr one.
