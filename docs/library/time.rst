...
**Time Epoch**: The Unix, Windows, Webassembly, RP2 and MIMXRT ports use
the standard for POSIX systems epoch of 1970-01-01 00:00:00 UTC. 
...
.. function:: mktime(date-time-tuple)
