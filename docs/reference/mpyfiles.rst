...
6       an architecture-specific flags byte follows the header
...
MPY files is used to indicate that no specific extensions are needed, saves one
byte in the final output binary.
