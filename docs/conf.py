...
# Capture the port to generate the docs for
...
# The members of the html_context dict are then available inside topindex.html
prefix = "http://micropython.org/resources/docs/port/"
html_context = {
    'port':micropy_port,
    'port_name':ports[micropy_port],
    'all_ports':[(n, prefix + p) for p, n in ports.items()],
}
