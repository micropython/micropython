...
An asterix indicates that the port has ongoing financial support from the vendor.

Tier 2 Ports
===============

✔️Ports in [Tier 2](https://docs.micropython.org/en/latest/develop/support_tiers.html)
...
| Port                       | Target                                                            | Quick Reference                                                         |
|----------------------------|-------------------------------------------------------------------|-------------------------------------------------------------------------|
| [cc3200](ports/cc3200)     | Texas Instruments CC3200 (including PyCom WiPy)                   | [For WiPy](https://docs.micropython.org/en/latest/wipy/quickref.html)   |
