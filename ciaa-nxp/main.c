...
soft_reset:
	...
	*/
	...
	aux[0] = 0x00; // addr
	aux[1] = 0x28; // data
	if(Board_I2C_Master_Write(0x50, (uint8_t*)aux, 2)>0)
	{
		printf("escribi OK\r\n");
	}
	else
	{
		printf("escribi error\r\n");
	}
	Board_I2C_Master_Write(0x50, (uint8_t*)aux, 0);
	...
	char data[20];
	aux[0] = 0x00; // addr
	Board_I2C_Master_Write(0x50, (uint8_t*)aux, 1); // escribo address
	int c = Board_I2C_Master_Read(0x50, (uint8_t*)data, 16); // leo datos
