...
The variables are:
    ...
    spi_standalone_args_list: tuple
...
pins. The variables are:
    ...
    encoder_loopback_out_pins: tuple
    encoder_loopback_in_pins: tuple

The Encoder instance will be created using:

    machine.Encoder(id, in0_pin, in1_pin)

And `encoder_loopback_out_pins` will be used to create `machine.Pin` instances.
