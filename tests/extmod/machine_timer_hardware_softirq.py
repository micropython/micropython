...
if sys.platform != "esp32":
    # Hardware timers via the machine.Timer interface are not supported on most ports.
    # A number of ports instead support hardware timers via the pyb.Timer interface.
    # The nrf port supports hardware timers via machine.Timer, however is incompatible:
