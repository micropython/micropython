...
#if 0
// The MK66F has LPUART0 instead of UART5. Figure out the LPUART0 support
// later.
#define MICROPY_HW_LPUART0_NUM      6
#define MICROPY_HW_LPUART0_TX       (pin_D9)    // D9(48)
#define MICROPY_HW_LPUART0_RX       (pin_D8)    // D8(47)
#define MICROPY_HW_LPUART0_RTS      (pin_E11)   // E11(56)
#define MICROPY_HW_LPUART0_CTS      (pin_E10)   // E10(57) also D11(55)
#endif
