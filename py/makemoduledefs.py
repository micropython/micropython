...
def find_module_registrations(c_file):
    ...
    with open(c_file) as c_file_obj:
        return list(re.findall(pattern, c_file_obj.read()))
...
def main():
    ...
    parser.add_argument("files", nargs="*",
                        help="list of object files matching c files to search")
    ...
    for obj_file in args.files:
        ...
        modules.extend(find_module_registrations(c_file))

    generate_module_table_header(modules)
