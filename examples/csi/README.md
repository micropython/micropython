...
- **22 - agc_gain** (int): AGC gain value (ESP32-S3/C3/C5/C6 only, 0 on other platforms)
- **23 - fft_gain** (int): FFT scaling gain (ESP32-S3/C3/C5/C6 only, 0 on other platforms)
...
- **Recommended board**: Use ``ESP32_GENERIC_C6`` board with ``CSI`` variant for pre-configured CSI support
...
- **Recommended board**: Use ``ESP32_GENERIC_S3`` board with ``CSI`` variant for ESP32-S3 with pre-configured CSI support
