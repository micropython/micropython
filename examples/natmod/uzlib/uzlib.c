...
mp_obj_t mpy_init(mp_obj_fun_bc_t *self, size_t n_args, size_t n_kw, mp_obj_t *args) {
    ...
    MP_OBJ_TYPE_SET_SLOT(&decompio_type, make_new, decompio_make_new, 1);
    MP_OBJ_TYPE_SET_SLOT(&decompio_type, protocol, &decompio_stream_p, 2);
    ...
    MP_OBJ_TYPE_SET_SLOT(&decompio_type, locals_dict, (void*)&decompio_locals_dict, 3);
