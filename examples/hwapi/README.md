...
following simple rules outlines below. The applications won't be able
to rely on advanced hardware capabilities of a particular boards and
will be limited to generic capabilities, but it's still possible to
write many useful applications in such way, with the obvious benefit of
...
blink not a on-board LED, but the one they connected externally.
...
potential, and let users anjoy it too. Good luck!
