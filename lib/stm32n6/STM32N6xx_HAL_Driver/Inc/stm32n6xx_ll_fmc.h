...
#ifndef STM32N6xx_LL_FMC_H
#define STM32N6xx_LL_FMC_H
...
/** @defgroup FMC_NAND_Bank FMC NAND Bank
  * @{
  */
#define FMC_NAND_BANK1                          (0x00000000U)
#define FMC_NAND_BANK2                          (0x00000400U)
#define FMC_NAND_BANK3                          (0x00000800U)
#define FMC_NAND_BANK4                          (0x00000C00U)
/**
  * @}
  */
...
/** @defgroup FMC_SDRAM_Command_Target FMC SDRAM Command Target
  * @{
  */
#define FMC_SDRAM_CMD_TARGET_BANK2              FMC_SDCMR_DS2
#define FMC_SDRAM_CMD_TARGET_BANK1              FMC_SDCMR_DS1
#define FMC_SDRAM_CMD_TARGET_BANK1_2            (FMC_SDCMR_DS2|FMC_SDCMR_DS1)
/**
  * @}
  */
...
/** @defgroup FMC_LL_Interrupt_definition FMC Low Layer Interrupt definition
  * @{
  */
#define FMC_IT_RISING_EDGE                      (0x00000001U)
#define FMC_IT_LEVEL                            (0x00000002U)
#define FMC_IT_FALLING_EDGE                     (0x00000004U)
