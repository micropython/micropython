...
#ifndef STM32N6xx_HAL_TIM_H
#define STM32N6xx_HAL_TIM_H
...
/** @defgroup TIM_Break_System TIM Break System
  * @{
  */
#define TIM_BREAK_SYSTEM_ECC_TCM             SYSCFG_CBR_CM55CACHEL  /*!< Enables and locks the Cortex-M55 TCM double ECC error signal connection to TIM1/8/15/16/17 break inputs */
#define TIM_BREAK_SYSTEM_ECC_CACHE           SYSCFG_CBR_CM55TCML    /*!< Enables and locks the Cortex-M55 cache double ECC error signa connection to TIM1/8/15/16/17 break inputs */
#define TIM_BREAK_SYSTEM_ECC_BACKUP_RAM      SYSCFG_CBR_BKPRAML     /*!< Enables and locks the Backup RAM ECC double error detection flag connection to TIM1/8/15/16/17 break inputs */
#define TIM_BREAK_SYSTEM_PVD                 SYSCFG_CBR_PVDL_LOCK   /*!< Enables and locks the PVD signal connection to TIM1/8/15/16/17 break inputs */
#define TIM_BREAK_SYSTEM_LOCKUP              SYSCFG_CBR_CM55L       /*!< Enables and locks the Cortex-M55 lockup signal connection to TIM1/8/15/16/17 break inputs */
/**
  * @}
  */
...
#define IS_TIM_BREAK_SYSTEM(__CONFIG__)    (((__CONFIG__) == TIM_BREAK_SYSTEM_ECC_TCM)        || \
                                            ((__CONFIG__) == TIM_BREAK_SYSTEM_ECC_CACHE)      || \
...
#include "stm32n6xx_hal_tim_ex.h"
