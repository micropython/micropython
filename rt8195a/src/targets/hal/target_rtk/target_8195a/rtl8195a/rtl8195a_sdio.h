...
/*****  Register Address *****/
//#define REG_SPDIO_TXFIFO_ADDR 						0xA0		// 4 Bytes
//#define REG_SPDIO_TXFIFO_SIZE						0xA4		// 4 Bytes
//#define REG_SPDIO_TXFIFO_WPTR						0xA8		// 4 Bytes
//#define REG_SPDIO_TXFIFO_RPTR						0xAC		// 4 Bytes
...
typedef struct _SDIO_TX_DESC{
	...
	// u4Byte 1
#if (SYSTEM_ENDIAN==PLATFORM_LITTLE_ENDIAN)
    u32 type:4;             // bit[3:0], the packet type
    u32 rsvd1:28;
#else
    u32 rsvd1:28;
    u32 type:4;             // bit[3:0], the packet type
...
typedef struct _SDIO_RX_DESC{
	...
	// u4Byte 1
#if (SYSTEM_ENDIAN==PLATFORM_LITTLE_ENDIAN)
	u32	type:4;         // bit[3:0], the type of this packet
	u32	rsvd1:28;       // bit[31:4]
#else
    u32 rsvd1:28;       // bit[31:4]
    u32 type:4;         // bit[3:0], the type of this packet
#endif
...
//	PSDIO_RX_DESC pDesc;	// Point to the start of a RX packet. The packet start with a RX_DESC.
