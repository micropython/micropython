...
//
// Flash Map for System
//

#define FLASH_SYS_DATA_BASE             0x7e000

#define FLASH_SYS_DATA_ADDR(_offset)    (FLASH_SYS_DATA_BASE + _offset)

#define FLASH_SYS_DATA_OFFSET_0         0x0
#define FLASH_SYS_DATA_MAC_ADDR_LOW     0x0118
#define FLASH_SYS_DATA_MAC_ADDR_HIGH    0x011c
#define FLASH_SYS_DATA_WAC_ADDR         0x0120
#define FLASH_SYS_DATA_HAP_KEYPAIR_ADDR 0x0140
#define FLASH_SYS_DATA_HAP_PAIRING_ADDR 0x0190
